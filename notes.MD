...
The presented algorithms are agnostic in regards to the underlying hypergraph representation. The implementations are almost identical to the pseudocode.
