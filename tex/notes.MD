...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{./img/dblp_tvd_rules_strat_s.png}
    \caption{Number of rule executions for DBLP coauthor graph per rule strategy, $n=100$}
    \label{dblp_rules_strat_s}
\end{figure}
$$
