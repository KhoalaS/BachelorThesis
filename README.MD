...
We additionally conduct benchmarks for the rules. We aim for a sub 30 second execution time on a pseudo-random graph with one million vertices and two million edges.
